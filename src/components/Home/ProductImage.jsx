...
const ProductImage = ({ getImageName, getImageValue }) => {
  ...
  if (getImageName === 'sweater' && getImageValue === 1) {
    return (
      <Card.Cover source={require('../../../assets/images/clothes/Blue_Front_900x.jpg')} />
    );
  };

  if (getImageName === 'sweater' && getImageValue === 2) {
    return (
      <Card.Cover source={require('../../../assets/images/clothes/Green_front_900x.jpg')} />
    );
  };

  if (getImageName === 'sweater' && getImageValue === 3) {
    return (
      <Card.Cover source={require('../../../assets/images/clothes/Lemon_Front_900x.jpg')} />
    );
  };

  if (getImageName === 'sweater' && getImageValue === 4) {
    return (
      <Card.Cover source={require('../../../assets/images/clothes/NA_Back_900x.jpg')} />
    );
  };

  if (getImageName === 'sweater' && getImageValue === 5) {
    return (
      <Card.Cover source={require('../../../assets/images/clothes/NA_Front_900x.jpg')} />
    );
  };
